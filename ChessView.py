...
#    root = tkinter.Toplevel()
    ...
    img = tkinter.PhotoImage(file="/home/chy/cchess-zero-master/images/WHITE.GIF")
    ...
    def draw_board(self, board):
        ...
        if board.selected_piece:
            for (x, y) in board.selected_piece.get_move_locs(board):
                self.move_images.append(tkinter.PhotoImage(file="/home/chy/cchess-zero-master/images/OOS.GIF"))
    ...
    def __init__(self, control, board):
        ...
        self.lb.bind('<<ListboxSelect>>', self.printList)  # Double-    <Button-1>  <Key-H>
        self.board = board
        self.last_text_x = 0
        self.last_text_y = 0
